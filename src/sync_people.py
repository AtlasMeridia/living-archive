...
Status: Show current state of people in both stores.

Run: python -m src.sync_people [status|pull|push]
"""
...
def cmd_push():
    ...
    Only pushes if the registry person has a name; won't overwrite
    manual Immich edits unless they are currently blank.
    """
